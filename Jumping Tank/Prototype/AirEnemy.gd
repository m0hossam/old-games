...
var can_shoot = true
var can_shoot_air = true
var found_player = false
var found_air_player = false
var rotation_speed = 2
var speed = 100
var velocity = Vector2.ZERO
var direction = Vector2.ZERO
var player_body = null #to keep track of player pos
var player_air_body = null
var wandering = false
...
func shoot_air():
	if can_shoot_air:
		...
		var bullet = bullet_scn.instance()
		get_parent().add_child(bullet)
		bullet.collision_layer = 0b10
		bullet.collision_mask = 0b10
		bullet.position = global_position
		bullet.update_direction(global_position.direction_to(player_air_body.global_position), true)
...
func _on_AirZone_body_entered(body):
	if body.name == "Player":
		found_air_player = true
		player_air_body = body

func _on_AirTimer_timeout():
	can_shoot_air = true

func _on_AirZone_body_exited(body):
	if body.name == "Player":
		player_air_body = null
		found_air_player = false
